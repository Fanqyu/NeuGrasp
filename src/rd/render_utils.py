...
from rd.modify_material import set_modify_material, set_modify_raw_material, set_modify_table_material, \
    set_modify_floor_material
...
g_shape_synset_name_pairs_all = {'02691156': 'aeroplane',
                                 ...
                                 '02834778': 'bicycle',
                                 '02843684': 'mailbox',
                                 # missing in objectnet3d, birdhouse, use view distribution of mailbox
                                 '02858304': 'boat',
                                 '02871439': 'bookshelf',
                                 '02876657': 'bottle',
                                 ...
                                 '04090263': 'rifle',
                                 '04099429': 'road_pole',
                                 # missing in objectnet3d, rocket, use view distribution of road_pole
                                 '04225987': 'skateboard',
                                 '04256520': 'sofa',
                                 '04330267': 'stove',
                                 ...
                                 '04401088': 'telephone',
                                 '04460130': 'road_pole',
                                 # missing in objectnet3d, tower, use view distribution of road_pole
                                 '04468005': 'train',
...
# def genCameraPosition(look_at):  # TODO
#     quat_list = []
#     rot_list = []
#     trans_list = []
#     position_list = []
    ...
    def lightModeSelect(self, light_mode):
        if light_mode == "RGB":
            ...
            bpy.data.worlds["World"].node_tree.nodes["Background"].inputs[
                1].default_value = self.src_energy_for_rgb_render
