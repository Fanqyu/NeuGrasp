...
urdf_path = code_root + '/data/urdfs/pile/train'  # NOTE
...
origin_root_path = '/path/to/NeuGraspData/data/giga_hemisphere_train_0827/pile_full/6_M_rand/pile_%d-%d' % (
    830 * (SCENE_NUM // 830), 830 * (SCENE_NUM // 830) + 830)  # NOTE: used to generate background

output_root_path = '/path/to/NeuGraspData/data/giga_hemisphere_train_0827/pile_full_bg/6_M_rand/pile_%d-%d' % (
    830 * (SCENE_NUM // 830), 830 * (SCENE_NUM // 830) + 830)

raw_urdfs_and_poses_dir_path = "/path/to/NeuGraspData/data/GIGA/data_pile_train_raw/mesh_pose_list"  # NOTE
