...
# obj_texture_image_idxfile = "test_paths.txt"  # NOTE

# output_root_path = ("/path/to/NeuGraspData/data/giga_hemisphere_train_0606/pile_full/6_M_rand"
#                     "/pile_%d-%d") % (
#                        830 * (SCENE_NUM // 830), 830 * (SCENE_NUM // 830) + 830)  # NOTE
output_root_path = "/path/to/temp"

# output_root_path = "/path/to/temp/new_view/pile_%d-%d" % (
#     830 * (SCENE_NUM // 830), 830 * (SCENE_NUM // 830) + 830)  # NOTE

raw_urdfs_and_poses_dir_path = "/path/to/NeuGraspData/data/GIGA/data_pile_train_raw/mesh_pose_list"  # NOTE
# raw_urdfs_and_poses_dir_path = "/path/to/NeuGraspData/data_multi_gripper/info_grasps_scenes
# /train_raw_pile/mesh_pose_list"  # NOTE
...
def genCameraPosition(look_at):
    ...
    alpha_delta = (math.pi / 2) / (num_positions - 1)
    z_delta = (z_end - z_start) / (num_positions - 1)
    ...
    for i in range(num_positions):
        ...
        x = r * math.cos(alpha1) * flag_x
        y = r * math.sin(alpha1) * flag_y
        position = np.array([x, y, z]) + look_at
